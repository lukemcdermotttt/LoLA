...
model_config_path="configs/model/inference_llama3_2_1b_prefill.yaml" #"configs/model/inference_llama3_2_1b_global=0_local=64.yaml" #"configs/model/inference_llama3_2_1b_global=0_local=0.yaml"
...
--task wikitext --num_shots 0 --verbose --no_cache \
--project_name lolcat \
