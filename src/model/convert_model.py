...
def get_attention(attention_type: str, **kwargs: any):
    ...
    #NOTE: Added!
    elif attention_type == 'lolcats_llama_window_sw_sparse':
        from .linear_attention import LolcatsSparseSlidingWindowAttention
        return partial(LolcatsSparseSlidingWindowAttention, **kwargs)
    ...
    elif attention_type == 'lolcats_llama_window_sw_baseline':
        from .linear_attention import LolcatsLinearSlidingWindowAttentionBaseline
        return partial(LolcatsLinearSlidingWindowAttentionBaseline, **kwargs)
...
def get_attention_cache(attention_type: str, past_key_values: any = None):
    ...
    # print(f'Returning attention cache based on attention_type == {attention_type}')
        ...
        from .linear_attention import LinearAttentionSparsePrefillSlidingWindowCache
        return LinearAttentionSparsePrefillSlidingWindowCache()
